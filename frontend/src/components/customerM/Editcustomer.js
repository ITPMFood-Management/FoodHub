...
const Editcustomer = () => {
  ...
  const getData = () => {
    axios
      .get(`http://localhost:8070/customer/get/${params.id}`)
      .then((res) => {
  ...
  const submit = () => {
    ...
    axios
      .put(`http://localhost:8070/customer/update/${params.id}`, data)
      .then((res) => {
        console.log(res);
      });
  };
              ...
              <div className="mt-10 justify-center text-center ">
                ...
                <a href="/customerlist">
                  <button
                    ...
                    class="align-middle py-2.5 px-5 mr-20 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                  >
                    Submit
                  </button>{" "}
                </a>
