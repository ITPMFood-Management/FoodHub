          ...
          <header class="text-gray-400  body-font  fixed">
            <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center fixed bg-white border-2 border-slate-100">
              ...
              <div class="flex border-2 rounded">
                ...
                ></span>
                <button
                  class="flex items-center justify-center px-4 border-l bg-blue-800 rounded"
                  type="submit"
                >
                  <svg
                    aria-hidden="true"
            ...
            <div class="overflow-x-auto">
              <div class="align-middle inline-block min-w-full">
                <div class="shadow overflow-hidden">
                  <div className="text-3xl text-black mt-28 text-center mb-6">
                    {" "}
                    All Customers
                  </div>
                  <button
                  ...
                  <table
                    class="table-fixed min-w-full divide-y divide-gray-200 border-2 border-y border-black"
                    id="content"
                  >
