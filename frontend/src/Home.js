    ...
    <section class="text-gray-600 body-font ">
      <div class="shadow-md w-full fixed top-0 left-0">
        <div className="md:flex items-center justify-between bg-zinc-800 py-4 md:px-10 px-7 ">
          ...
          <ul
            className={`md:flex md:items-center absolute bg-zinc-800 md:pb-0 mr-0 pb-12  md:static md:z-auto z-[-1] left-12 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500  ease-in ${
          ...
          >
            ...
            <a
              href="#"
              class="flex items-center  ml-36 hover:text-blue-100 text-white"
            >
              <span class="inline-flex mr-1">
                ...
                >
                  <path
                    ...
                    stroke-width="2"
                    d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1 mr-4"
                  ></path>
                </svg>
              </span>
              Logout
